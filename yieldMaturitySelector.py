        ...
        if yieldtype == 'nominal':
            ...
            if not FD:
                nominal_yields_2_10y_eom = nominal_yields_2_10y[
                    nominal_yields_2_10y['Date'].dt.is_month_end is True].reset_index(inplace=False, drop=True)
                ...
                nominal_yields_2_10y_eom_shifted = nominal_yields_2_10y_shifted[
                    nominal_yields_2_10y_shifted['Date'].dt.is_month_end is True].reset_index(inplace=False, drop=True)
            ...
            if not FD:
                real_yields_2_10y_eom = real_yields_2_10y[
                    real_yields_2_10y['Date'].dt.is_month_end is True].reset_index(inplace=False, drop=True)
                ...
                real_yields_2_10y_eom_shifted = real_yields_2_10y_shifted[
                    real_yields_2_10y_shifted['Date'].dt.is_month_end is True].reset_index(inplace=False, drop=True)
